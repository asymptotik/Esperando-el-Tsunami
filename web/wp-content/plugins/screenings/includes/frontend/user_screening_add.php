...
<p>It is really exciting for us to share with you this film in such a unique way. We encourage you to make the screening open to strangers, it's part of what we envision. These screenings are moments to come together, and we hope that they become rewarding experiences.</b>
...
<p>We will approve your screening as soon as possible and inform you by email once it has been approved. Please add <b>" . get_option('screenings_notify_from_email') . "</b> to your address book to prevent the email from being categorized as junk mail.</p>
<p>You should receive an email shortly with the details you just registered and your log-in info for <a href=\"http://www.esperando.cc/\">www.esperando.cc</a> so you can edit and manage your event.</p>
<p>Please make sure you have received this email.</p>
<p>Thanks!</p>
