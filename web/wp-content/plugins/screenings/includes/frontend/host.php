    ...
    <table>
      ...
      <tr>
        ...
        <td>
          ...
          <input id="screening_max" class="required number initialValue" tabindex="9" type="text" name="screening_max" id="screening_max" alt="Maximum Attendants" /><br/>
          <input type="checkbox" tabindex="10" name="screening_status" value="1" /><span class="sub">Already fully booked</span>
        </td>
      </tr>
      ...
      <tr>
        <td>
          ...
          <input class="required initialValue" tabindex="2" type="text" name="screening_address" id="screening_address" alt="Street name &amp; number" /><br/>
          <input type="checkbox" tabindex="3" name="screening_address_show" value="1" /><span class="sub">don't make this info visible!</span>
        </td>
        <td class="lc-host-form-empty-col">&nbsp;</td>
        <td>
          <label for="screening_city">City (r)(v)</label><br/>
          <input class="required initialValue" tabindex="4" name="screening_city" id="screening_city" type="text" alt="City" />
        </td>
      </tr>
      ...
      <tr>
				<td>
				  ...
				  <input class="required initialValue" tabindex="5" type="text" name="screening_postalcode" id="screening_postalcode" alt="Postal Code" />
				</td>
				<td class="lc-host-form-empty-col">&nbsp;</td>
				<td>
				  <label for="screening_country">Country (r)(v)</label><br/>
          <select class="required" tabindex="6" name="screening_country" id="screening_country">
      ...
      <tr>
        <td>
          ...
          <input class="required datepicker initialValue" tabindex="7" type="text" name="screening_date" id="screening_date" alt="mm/dd/yyyy" /> 
        </td>
        <td class="lc-host-form-empty-col">&nbsp;</td>

				<td>
          <label for="screening_date">Time hh:mm (r)(v)</label><br/>
          <input class="required timepicker initialValue" tabindex="8" type="text" name="screening_time" id="screening_time" alt="hh:mm" />
        </td>
      </tr>
