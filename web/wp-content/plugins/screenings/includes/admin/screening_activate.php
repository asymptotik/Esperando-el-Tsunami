...
<p>As a host of a Private-Public Concert you can invite friends to your screening any way you prefer. In addition to this it will be possible for others to contact you via the <a href="' . bloginfo('url') . 'screenings/all">Attend a Concert</a> section on <a href="' . bloginfo('url') . '">' . bloginfo('url') . '</a>. Here people can request to be invited to your Private-Public Concert. We encourage you to reply to all the emails you might receive concerning your screening.</p>
...
<p>We encourage you to <strong>spread the word</strong> about your <strong>Private-Public Concert</strong>. A good idea is to create a Facebook event for your screening - then it is easy to invite friends.</p>
...
<p>For more info about the Private-Public Concerts please refer to <a href="' . bloginfo('url') . 'screenings/host-a-screening/">' . bloginfo('url') . 'screenings/host-a-screening/</a></p>
