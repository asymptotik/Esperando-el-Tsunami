...
The concert is now featured in the concert calendar at ' . bloginfo('url') . 'concerts/all/</p>

<p>As a host of a Private-Public Concert you can invite friends to your concert any way you prefer. In addition to this it will be possible for others to contact you via the <a href="' . bloginfo('url') . 'concerts/all">Attend a Concert</a> section on <a href="' . bloginfo('url') . '">' . bloginfo('url') . '</a>. Here people can request to be invited to your Private-Public Concert. We encourage you to reply to all the emails you might receive concerning your concert.</p>
<p>If you need to change any details regarding your Private-Public Concert or <strong>mark the concert as fully booked </strong>you can login at <a href="' . bloginfo('url') . 'concerts/manage/" target="_blank">' . bloginfo('url') . 'concerts/manage/</a>.Please make sure you display the <strong>Time</strong> for the concert correct. We use the 24-hour clock on the site. I also suggest that you let your guests know who you are and how you will screen the film? And if they should bring something? etc You can do this in the <strong>Additional Info</strong> field.</p> 
...
<p>For more info about the Private-Public Concerts please refer to <a href="' . bloginfo('url') . 'concerts/host-a-concert/">' . bloginfo('url') . 'concerts/host-a-concert/</a></p>
