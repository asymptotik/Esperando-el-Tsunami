  ...
  <form action="<?php echo str_replace("%7E", "~", $_SERVER["REQUEST_URI"]) ?>" method="post" name="concert_form" class="validate" id="concert_form">
    ...
    <table>
	      ...
	      <td class="lc-host-form-empty-col">&nbsp;</td>
				<td>
				  ...
				  <?php foreach ($regions as $region) { 
					...
					<input name="concert_venue_country" style="display:none;" type="text" id="concert_venue_country" value="<?php echo esc_attr($concert_country)?>"/>
					</td>
			</tr>
      ...
      <tr>
          ...
          <input class="required initialValue" tabindex="6" name="concert_venue_city" id="concert_venue_city" type="text" alt="City" />
        </td>
        <td class="lc-host-form-empty-col">&nbsp;</td>
        <td>
				  <label for="concert_postalcode">Postal Code (r)(v)</label><br/>
				  <input class="required initialValue" tabindex="7" type="text" name="concert_venue_postalcode" id="concert_venue_postalcode" alt="Postal Code" />
				</td>
