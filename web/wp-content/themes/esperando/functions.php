<?php
  ...
  function lc_button_md_shortcode_handler( $atts, $content = null ) {
   extract( shortcode_atts( array(
   		'href' => __(''),
      'text' => __('press me')
      ), $atts ) );
      ...
      return '<a class="btn-rect btn-rect-md" href="'. $href .'">' . $text . '</a>';
  }
  
  add_shortcode( 'lulacruza-button-medium', 'lc_button_md_shortcode_handler' );
